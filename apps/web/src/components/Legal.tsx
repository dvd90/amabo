...
export function PrivacyPage() {
  return (
    <Shell title="Privacy Policy">
      ...
      <h2>The AI</h2>
      <p>
        Your creature’s diary is written with the help of a large language model — depending on our
        configuration, Meta’s Llama, xAI’s Grok, or Anthropic’s Claude. What we send it: the
        creature’s name, its state, and its short memories. What we never send it: your email or
